...
const ProductSlider = ({ data }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Modal style={styles.modalView} visible={visible} onRequestClose={() => { setVisible(false) }}>
                <View style={styles.bgColor}>
                    <Icons style={styles.caancel} onPress={() => { onBack() }} color="white" name="cancel" size={36} />
                </View>

                <ImageViewer style={styles.modalView} enableImageZoom={true} imageUrls={imgArray}
